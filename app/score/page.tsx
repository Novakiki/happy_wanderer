  ...
  return (
    ...
    >
      ...
      <section className={`transition-opacity duration-1000 ${isReady ? 'opacity-100' : 'opacity-0'}`}>
        <div className="max-w-4xl mx-auto px-6 pt-24 pb-8">
          ...
          >
            ...
            <a
              href="/chat"
              className="inline-flex items-center gap-2 rounded-full border border-white/20 text-white/70 px-6 py-3 text-xs uppercase tracking-[0.2em] hover:border-white/40 hover:text-white transition-colors"
            >
      ...
      <section className="max-w-4xl mx-auto px-6 mt-12">
        <p
          className="text-xs uppercase tracking-[0.3em] text-white/40 mb-4 animate-fade-in-up"
          style={{ animationDelay: '700ms', animationFillMode: 'both' }}
        >
          The Score
        </p>
        <div
          className="flex flex-wrap items-center gap-4 text-xs text-white/40 mb-2 animate-fade-in-up"
